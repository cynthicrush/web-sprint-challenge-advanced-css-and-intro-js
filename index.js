...
function get20s(artists){
  ...
  for (const artist of artists) {
    ...
    const birthYear = parseInt(yearsArray[0]);
    const deathYear = parseInt(yearsArray[1]);
...
const addingArtist = { 
  ...
  years: "2001 -     ",
  genre: "Cute", 
  nationality: "Chinese becoming American citizen",
  bio: "目前身份是一名学生, 平时空闲的时候是一名非专业导播.",
};
function addArtist(artists){
    artists.push(addingArtist);
    return artists;
  }
